...
import 'package:flutters/background.dart';
import 'package:flutters/bird.dart';
import 'package:flutters/dialog.dart';
import 'package:flutters/floor.dart';
import 'package:flutters/level.dart';
import 'package:flutters/obstacle.dart';
import 'package:flutters/text.dart';
...
class FluttersGame extends Game {
  ...
  FluttersGame(screenDimensions) {
    ...
    floorText = TextComponent(
        this, 'Tap to Find My Ship!', 40.0, viewport.height - floorHeight / 2);
